import { chatSide, type ChatSide } from '@/definitions/chat'
import { useCallback, useEffect, useRef, useState } from 'react'
import type { MessageController } from './useTwinChat'
...
export function useGladiaRecorder({
    sampleRate = 16000,
    numChannels = 1,
    ...
    const start = useCallback(
        async (
            ...
            const ws = await startSession(inLang, outLang)
